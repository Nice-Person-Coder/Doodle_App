...
document.getElementById("Name_Update").innerHTML = 'Sketch To be Drawn: ' + sketch;
...
function gotResult(error, results){
    ...
    document.getElementById('Sketch_Update').innerHTML = 'Your Sketch: ' + drawn_sketch;

    document.getElementById('Confidence_Update').innerHTML = 'Confidence: ' + Math.round(results[0].confidence * 100) + '%';
}

function check_sketch(){
    timer_counter++;
    document.getElementById("Time_Update").innerHTML;
